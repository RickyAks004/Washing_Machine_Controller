...
REM
REM Generated by Vivado on Mon Oct 27 13:26:29 +0530 2025
...
echo "xvlog --incr --relax -prj washing_machine_controller_vlog.prj"
call xvlog  --incr --relax -prj washing_machine_controller_vlog.prj -log xvlog.log
